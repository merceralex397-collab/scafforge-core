...
| 1 | DIAG-001 | Emit the authoritative disposition bundle from audit outputs | audit-disposition | complete | done | completed | verified | no | medium | ARCH-001 | - |
| 1 | MUT-001 | Generalize the pivot runtime adapter into the package-wide runtime bridge | runtime-adapter | complete | done | completed | verified | yes | medium | ARCH-001 | - |
| 1 | PIVOT-001 | Formalize pivot-state ownership and bounded persistence rules | pivot-state | complete | done | completed | verified | yes | medium | ARCH-001 | - |
...
| 2 | AUDIT-001 | Align audit modules to the runtime invariant and restart contract | audit-contract | complete | done | completed | verified | yes | medium | INV-001, INV-002, RESTART-002 | - |
...
| 5 | GREEN-001 | Add weak-model greenfield self-sufficiency proof without duplicating the greenfield gate | greenfield-proof | complete | done | completed | verified | no | high | STACK-002, CONTRACT-001, RESTART-001, AUDIT-001 | - |
| 5 | DOCS-001 | Post-implementation reconcile root docs and contracts to the shipped package state | package-docs | complete | done | completed | verified | yes | low | ARCH-002, CONTRACT-001 | - |
