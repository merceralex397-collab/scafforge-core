...
- dependent_tickets_waiting_on_current: CONTENT-001
...
- Downstream tickets CONTENT-001 remain formally blocked until CORE-002 reaches done.

## Next Action

Keep CORE-002 as the foreground ticket and continue its lifecycle from qa. Historical done-ticket reverification stays secondary until the active open ticket is resolved.
