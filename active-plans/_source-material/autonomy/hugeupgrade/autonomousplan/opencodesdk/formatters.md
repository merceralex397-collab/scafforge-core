---
source_url: https://opencode.ai/docs/formatters
fetched_with: http
---
...
So if your project has `prettier`

in your `package.json`

, OpenCode will automatically use it.
...
|---|---|---|
`disabled` | boolean | Set this to `true` to disable the formatter | `command` | string[] | The command to run for formatting | `environment` | object | Environment variables to set when running the formatter | `extensions` | string[] | File extensions this formatter should handle |

Let’s look at some examples.

To disable **all** formatters globally, set `formatter`

to `false`

:

To disable a **specific** formatter, set `disabled`
