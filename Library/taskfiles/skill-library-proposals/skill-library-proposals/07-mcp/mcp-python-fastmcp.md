...
display_name: MCP Python FastMCP
category: MCP Skills
priority: P1
status: candidate
sources:
...
## Why it belongs
A likely near-term stack for you.
...
- when a plan, ticket, or repo state would benefit from explicit guardrails around mcp python fastmcp

## Notes for implementation
- Keep the scope explicit. The name should not hide unrelated responsibilities.
- Prefer references, scripts, examples, or evals when mcp python fastmcp would otherwise become a vague checklist.
